from english_text_normalization import (
    ...
    remove_linebreaks, remove_quotation_marks_when_used_as_itemization,
    remove_repeated_spaces, remove_stars, remove_tilde,
    remove_underscore_characters, replace_etc_with_et_cetera,
