...
# def unidecode_expect_ascii(string: str, errors: str = 'ignore', replace_str: str = '?', exception_set: Set[str] = {}) -> str:
...
#   return _unidecode(string, errors, replace_str, exception_set)
...
# def _unidecode(string: str, errors: str, replace_str: str, exception_set: Set[str] = {}) -> str:
#   retval = []

#   for index, char in enumerate(string):
#     if char in exception_set:
#       retval.append(char)
#       continue
